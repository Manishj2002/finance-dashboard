...
const getDashboardSummary = async (req, res) => {
    try {
        ...
        const currentMonthIncome = await prisma_1.default.transaction.aggregate({
            where: {
                userId: req.userId,
                type: "INCOME",
        ...
        const currentMonthExpenses = await prisma_1.default.transaction.aggregate({
            where: {
                userId: req.userId,
                type: "EXPENSE",
                date: { gte: currentMonthStart, lte: currentMonthEnd },
        ...
        const lastMonthIncome = await prisma_1.default.transaction.aggregate({
            where: {
                userId: req.userId,
                type: "INCOME",
        ...
        const lastMonthExpenses = await prisma_1.default.transaction.aggregate({
            where: {
                userId: req.userId,
                type: "EXPENSE",
                date: { gte: lastMonthStart, lte: lastMonthEnd },
        ...
        const spendingByCategory = await prisma_1.default.transaction.groupBy({
            by: ["categoryId"],
            where: {
                userId: req.userId,
                type: "EXPENSE",
